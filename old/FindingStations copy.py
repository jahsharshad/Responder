...
AlamedaStationNum, AlamedaStationAddresses, AlamedaStationNames = stationCalc('Clay County','FL')
AlamedaHospitalNum, AlamedaHospAddresses, AlamedaHospNames = hospitalCalc('Clay County','FL')
